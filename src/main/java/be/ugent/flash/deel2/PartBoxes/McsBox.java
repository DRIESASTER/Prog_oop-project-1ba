...
import be.ugent.flash.deel2.PartBoxes.MultiBox;
...
public class McsBox extends MultiBox {

    private ArrayList<TextArea> newAnswers = new ArrayList<>();

    public McsBox(GeopendeDBController controller) {
        super(controller);
        createBox();
    }
    ...
    public void createBox() {
        ...
        int rowCounter = 0;
        //voor elk part een textfield etc aanmaken, juiste functies binden...
        for(Part answer : answers) {
            ...
            try{
                ...
                //part is null, dus kan geen string maken, tekst blijft leeg
            }
    ...
    public void boxOpslaan(PartDAO pDAO) {
        ...
        //checkt of er juist 1 correct antwoord aangeduid is
